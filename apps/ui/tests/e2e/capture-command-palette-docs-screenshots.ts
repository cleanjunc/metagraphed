 ...
 *
 * Usage:
 *   UI_BASE_URL=http://127.0.0.1:8085 VARIANT=before node tests/e2e/capture-command-palette-docs-screenshots.ts
 *   UI_BASE_URL=http://127.0.0.1:8085 VARIANT=after  node tests/e2e/capture-command-palette-docs-screenshots.ts
 */
